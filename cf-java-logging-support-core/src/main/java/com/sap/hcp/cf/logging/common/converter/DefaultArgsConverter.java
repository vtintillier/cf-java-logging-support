	...
	public void convert(Object[] arguments, StringBuilder appendTo) {
		...
		if (!customFields.isEmpty()) {
			try {
				...
				/*
				 * -- no matter whether we embed or not, it seems easier to compose
				 * -- a JSON object from the key/value pairs.
				 * -- if we embed that object, we simply chop off the outermost curly braces.
				 */
