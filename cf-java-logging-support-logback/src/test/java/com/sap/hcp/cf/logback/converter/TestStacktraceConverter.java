...
public class TestStacktraceConverter extends AbstractConverterTest {
    ...
    public void testEmpty() {
        LogbackStacktraceConverter stc = new LogbackStacktraceConverter();
        stc.start();
        assertThat(stc.convert(makeEvent(null, null, null)), nullValue());
    }
     ...
     * occurs All the f3 lines are within the first MAX_SIZE/3 chars. All the f1
     * lines are within the last MAX_SIZE/3*2 chars. The test succeeds if the
     * truncated stack trace contains all the f1 and f3 lines.
     */
    @Test
    public void testHuge() throws Exception {
        StacktraceGenerator stacktraceGenerator = new StacktraceGenerator(210, 330, 130);
