...
public class RequestLoggingFilter implements Filter {
	...
	private void doFilterRequest(HttpServletRequest httpRequest, HttpServletResponse httpResponse, FilterChain chain) throws IOException, ServletException {
		 ...
		 * --  a) we create a log record using our library and log it via STDOUT
		 * --  b) keep track of certain header fields so that they are available in later processing steps
